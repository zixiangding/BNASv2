...
from model_search_imagenet_b import Network
...
parser.add_argument('--en_layers', type=int, default=1, help='number of en layers')
parser.add_argument('--model_path', type=str, default='saved_models', help='path to save the model')
parser.add_argument('--cutout', action='store_true', default=False, help='use cutout')
parser.add_argument('--cutout_length', type=int, default=16, help='cutout length')
parser.add_argument('--drop_path_prob', type=float, default=0.3, help='drop path probability')
parser.add_argument('--save', type=str, default='./search_imagenet_b', help='experiment name')
...
def main():
   ...
   # dataset prepare
    ...
    model = Network(args.init_channels, CLASSES, args.layers, criterion, en_layers=args.en_layers)
